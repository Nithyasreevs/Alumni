...
// index.js
function buildSSORedirectURL(params) {
...
async function decryptSSOToken(token, symmetricKeyBase64) {
  const alg = "dir";
  const enc = "A256GCM";
  try {
    ...
    const jwk = {
      kty: "oct",
      k: symmetricKey.toString("base64url")
...
exports.buildSSORedirectURL = buildSSORedirectURL;
exports.decryptSSOToken = decryptSSOToken;
